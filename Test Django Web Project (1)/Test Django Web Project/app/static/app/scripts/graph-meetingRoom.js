...
+function ($) {
  $(function () {
    ...
    $('#rowsPerPage').on('change',function(){
      if($('#rowsPerPage').val()=='chart2D'){
        $('#chart2W').addClass('hidden');
        $('#chart2M').addClass('hidden');
        $('#chart2D').removeClass('hidden');
        drawchart2D();
      }
      if($('#rowsPerPage').val()=='chart2W'){
        $('#chart2D').addClass('hidden');
        $('#chart2M').addClass('hidden');
        $('#chart2W').removeClass('hidden');
        drawchart2W();
      }
      if($('#rowsPerPage').val()=='chart2M'){
        $('#chart2D').addClass('hidden');
        $('#chart2W').addClass('hidden');
        $('#chart2M').removeClass('hidden');
        drawchart2M();
      }
    });
  });
